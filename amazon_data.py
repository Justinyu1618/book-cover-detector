...
def create_request(ASIN):
  ...
  param_date = t.strftime('%Y-%m-%dT%H:%M:%SZ')
  ...
  # canonical_querystring += '&X-Amz-Date=' + param_date
...
def get_response(ASIN):
  print('\nBEGIN REQUEST++++++++++++++++++++++++++++++++++++')
  request_url = create_request(ASIN)
